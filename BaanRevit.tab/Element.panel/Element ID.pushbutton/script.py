# -*- coding: utf-8 -*-
__title__ = "Get Element ID"                           # Name of the button displayed in Revit UI
__doc__ = """Version = 1.0
Date    = 28.08.2023
...
- 
_____________________________________________________________________
Author: Chatpong Deepet"""                                           # Button Description shown in Revit UI
...
__max_revit_ver = 2021                                          # Limit your Scripts to certain Revit versions if it's not compatible due to RevitAPI Changes.
